    ...
    class YITH_YWRAQ_Frontend {
        ...
        public function hide_add_to_cart_loop( $link , $product) {
	        ...
	        if ( ! catalog_mode_plugin_enabled() && get_option( 'ywraq_hide_add_to_cart' ) == 'yes'){
		        ...
		        if ( ! $product->is_type('variable') || get_option( 'yith-wccl-enable-in-loop' ) == 'yes' || $product->get_price() == '' ) {
			        return '';
		        }
	        }
        ...
        public function print_button( $product_id = false ){
            ...
            wc_get_template('add-to-quote.php', apply_filters('ywraq_add_to_quote_args', $args), YITH_YWRAQ_DIR, YITH_YWRAQ_DIR);
