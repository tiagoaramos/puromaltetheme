...
<?php add_action( 'wp_enqueue_scripts', 'brewhouse_scripts' ); ?>
...
<body id="skrollr-body" <?php body_class(); ?>>
	...
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'brewhouse' ); ?></a>

	<header id="masthead" class="site-header" role="banner">
    	<div class="grid grid-pad">
			<div class="site-branding col-9-12 mobile-col-8-12"> 
        	<?php if ( get_theme_mod( 'brewhouse_logo' ) ) : ?>
    		<div class="site-logo"> 
       			<a href='<?php echo esc_url( home_url( '/' ) ); ?>' title='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>' rel='home'><img src='<?php echo esc_url( get_theme_mod( 'brewhouse_logo' ) ); // change your logo ?>' <?php if ( get_theme_mod( 'logo_size' ) ) : ?>width="<?php echo get_theme_mod( 'logo_size' ); ?>"<?php endif; ?> alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>  
    		</div><!-- .site-logo --> 
			<?php else : ?> 
    			<hgroup> 
			...
			<div class="col-3-12 mobile-col-4-12 push-right">
				<button class="toggle-menu menu-right push-right"><?php _e( '<span class="hide-on-mobile">Menu</span> <i class="fa fa-bars"></i>', 'brewhouse' ); ?></button>
        	</div><!-- .mobile-col-4-12 --> 
        </div><!-- .grid -->  
