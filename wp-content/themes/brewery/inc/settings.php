		...
		'social'=>array(
			...
			'content'=>array(
				...
				'socials'=>array( 'type'=>'socials', 'ttl'=>'Social Buttons', 'value'=>array (
						'1' => Array (
							'ttl' => 'Facebook like',
							'code'=>'<iframe src="//www.facebook.com/plugins/like.php?href=wow_social_url&amp;send=false&amp;layout=box_count&amp;width=50&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=65&amp;locale=en_US" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height:65px;" allowTransparency="true"></iframe>',
							'show' => '1'
						),
						'2' => Array (
							'ttl' => 'Twitter',
			...
			<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript">
						...
						'7' => Array (
							'ttl' => 'Pinterest',
							'code'=>'<a href="http://pinterest.com/pin/create/button/?url=wow_social_url&media=wow_social_img_url&description=wow_social_title" class="pin-it-button" count-layout="vertical"><img border="0" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a><script type="text/javascript" src="//assets.pinterest.com/js/pinit.js"></script>',
							'code'=>'<a href="http://pinterest.com/pin/create/button/?url=wow_social_url&media=wow_social_img_url&description=wow_social_title" class="pin-it-button" count-layout="vertical"><img border="0" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a><script type="text/javascript" src="//assets.pinterest.com/js/pinit.js"></script>',
							'show' => '0'
						),
						'8' => Array (
			 ...
			 (function() { 
				 ...
				 var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(li, s); 
						...
						'10' => Array (
							'ttl' => 'DZone',
							'code'=>'<script type="text/javascript">var dzone_url = "[wow_social_url]";</script>
			<script type="text/javascript">var dzone_title = "[wow_social_title]";</script>
			<script type="text/javascript">var dzone_blurb = "[wow_social_title]";</script>
			...
			<script language="javascript" src="http://widgets.dzone.com/links/widgets/zoneit.js"></script>',
						...
						'11' => Array (
							'ttl' => 'Topsy',
							'code'=>'<script type="text/javascript" src="http://button.topsy.com/widget/retweet-big?nick=[twitter_name]&url=[wow_social_url]"></script>',
							'show' => '0'
						),
						'12' => Array (
							'ttl' => 'Delicious',
							'code'=>'<img src="http://www.delicious.com/static/img/delicious.small.gif" height="10" width="10" alt="Delicious" />
            <a href="http://www.delicious.com/save" onclick="window.open("http://www.delicious.com/save?v=5&noui&jump=close&url="+encodeURIComponent("wow_social_url")+"&title="+encodeURIComponent("wow_social_title"),"delicious", "toolbar=no,width=550,height=550"); return false;"> Save </a>
...
(function() {
    ...
    window.onload = function() {
        FlattrLoader.render({
            "uid": "flattr",
            "url": "wow_social_url",
            "title": "wow_social_title",
            "description": "wow_social_desc"
        }, "flattrBtn", "replace");
    }
</script>
<div id="flattrBtn"></div>',
		...
		'seo'=>array(
			...
			'content'=>array(
				'wow_seo'=>array(
					'type'=>'check', 'name'=>'wow_seo','value'=>'1','ttl'=>'Built-in SEO. Disable this feature if you are using a third-party plugin'
				),
				'description'=>array(
			...
			'content'=>array(
				...
				'sitemap'=>array(
					...
					'content'=>array(
						...
						'nosearchresults'=>array(
							'type'=>'text','name'=>'nosearchresults','value'=>'','ttl'=>'Text for empty search result'
						),
					...
					'value'=>array (
						...
						'nosearchresults'=>'Sorry, but nothing matched your search terms. Please try again with some different keywords.',//------------------------------
				...
				'error'=>array(
					'type'=>'group', 'name'=>'error', 'ttl'=>'Messages & Contacts',
					'content'=>array(
						'errortext'=>array(
						...
						'emailfail'=>array(
							'type'=>'text','name'=>'emailfail','value'=>'','ttl'=>'Mail delivery fail text'
						),
						'contactemail'=>array(
							'type'=>'text','name'=>'contactemail','value'=>'','ttl'=>'Contact form email'
						),
						'contactname'=>array(
							'type'=>'text','name'=>'contactname','value'=>'','ttl'=>'Contact form name'
						),
						'contactsend'=>array(
							'type'=>'text','name'=>'contactsend','value'=>'','ttl'=>'Contact form Send button'
						),
						'contactsubject'=>array(
							'type'=>'text','name'=>'contactsubject','value'=>'','ttl'=>'Contact form subject'
						),
						'contactdepartment'=>array(
							'type'=>'text','name'=>'contactdepartment','value'=>'','ttl'=>'Contact form department'
						),
						'contactmessage'=>array(
							'type'=>'text','name'=>'contactmessage','value'=>'','ttl'=>'Contact form message'
						)
					),
					'value'=>array(
						...
						'emailfail'=>'Message was not sent!',//------------------------------
						'contactemail'=>'Email',//------------------------------
						'contactname'=>'Name',//------------------------------
		...
		'contacts'=>array(
			...
			'content'=>array(
				'txt'=>array(
					'type'=>'p','name'=>'','value'=>'
    <b>Theme Author:</b> <a href="http://wpwow.com">WPWOW</a><br />
    <b>Theme Homepage:</b> <a href="http://wpwow.com/'.$themename.'">http://wpwow.com/'.$themename.'</a><br />
    <b>Support Forums:</b> <a href="http://wpwow.com/support/forum/'.$themename.'-free-wordpress-theme">http://wpwow.com/support/forum/'.$themename.'-free-wordpress-theme</a>'
				)
			)
		),
		'updates'=>array(
